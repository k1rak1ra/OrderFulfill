package net.k1ra.orderfulfill.overlays
...
import net.k1ra.orderfulfill.databinding.ErrorOverlayBinding
...
class ErrorOverlay : DialogFragment() {
    ...
    private fun updateTextAndAction() {
        ...
        binding.errorOverlayContinue.setOnClickListener{ action?.run() }
    }
}